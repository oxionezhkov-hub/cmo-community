...
- **Дашборд отдела маркетинга** (`dashboard/`) — светлый дашборд по данным Яндекс.Директа, Метрики, Telegram-бота, amoCRM и Google Sheets с ИИ-инсайтами, автообновлением и дайджестом руководителю. Демо-режим работает без доступов: `node dashboard/collectors/collect.js`, затем открыть `dashboard/index.html`.
...
dashboard/            — дашборд отдела маркетинга: коллекторы API, модель данных, ИИ-инсайты
